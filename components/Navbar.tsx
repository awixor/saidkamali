    ...
    <>
      <nav className="sticky top-0 z-50 bg-background/95 backdrop-blur-sm border-b-2 border-accent/20">
        <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
          ...
          {/* Left side (RTL): Search + All videos */}
          ...
          <div className="flex lg:hidden items-center gap-1">
            <button
              onClick={() => setSearchOpen(true)}
              className="text-foreground/60 p-2 hover:bg-accent/5 rounded transition-colors duration-200"
              aria-label="بحث"
            >
            ...
            <button
              className="text-foreground p-2 hover:bg-accent/5 rounded transition-colors duration-200"
